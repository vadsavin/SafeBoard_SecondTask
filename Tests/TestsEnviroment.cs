...
namespace Tests
{
    public class TestsEnviroment
    {
        ...
        public static string RmMalvareFilePath      => Path.Combine(AffectedDirectory, "rm-rfmalvare.txt");
        public static string Rundll32FilePath       => Path.Combine(AffectedDirectory, "Rundll32.bat");

        public static ScannerRule JsRule            => new ScannerRule("JS", "<script>evil_script()</script>", @".*\.js\Z");
